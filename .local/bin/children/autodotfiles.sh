...
cp -r ~/.config/cava ~/gitvc/dotfiles/.config/ && cp -r ~/.config/fontconfig ~/gitvc/dotfiles/.config/ && cp -r ~/.config/gtk* ~/gitvc/dotfiles/.config/ && cp -r ~/.config/lf ~/gitvc/dotfiles/.config/ && cp -r ~/.config/mpv ~/gitvc/dotfiles/.config/ && cp -r ~/.config/neofetch ~/gitvc/dotfiles/.config/ && cp -r ~/.config/pulse ~/gitvc/dotfiles/.config/ && cp -r ~/.config/sxiv ~/gitvc/dotfiles/.config/ && cp -r ~/.config/zathura ~/gitvc/dotfiles/.config/ && cp ~/.config/mimeapps.list ~/gitvc/dotfiles/.config/ && cp -r ~/.config/dunst ~/gitvc/dotfiles/.config/ && cp -r ~/.config/htop ~/gitvc/dotfiles/.config/ && cp -r ~/.config/mpd ~/gitvc/dotfiles/.config/ && cp -r ~/.config/ncmpcpp ~/gitvc/dotfiles/.config/ && cp -r ~/.config/zsh ~/gitvc/dotfiles/.config/ && cp -r ~/.config/shell ~/gitvc/dotfiles/.config/ && cp -r ~/.config/wal ~/gitvc/dotfiles/.config/ && cp -r ~/.config/x11 ~/gitvc/dotfiles/.config/ && cp ~/.config/user-dirs.dirs ~/gitvc/dotfiles/.config/
